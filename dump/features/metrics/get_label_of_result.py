...
def get_args():
    ...
    parser.add_argument('--results-file', type=str, help="help", default='in/openimages_results.txt')
    parser.add_argument('--classes-file', type=str, help="help", default='in/classes.sorted.txt')
    parser.add_argument('--labels-map', type=str, help="help", default='in/dict.csv')
